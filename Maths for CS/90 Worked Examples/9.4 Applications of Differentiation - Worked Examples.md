...
**Question:** Explain applications of differentiation using [[turning point]], [[maximum]], and [[minimum]].

**Worked solution:**
1. A [[turning point]] is: a point where a curve changes from increasing to decreasing or vice versa.
2. [[maximum]] means: a point where the function value is greater than or equal to all nearby values.
3. [[minimum]] means: a point where the function value is less than or equal to all nearby values.
4. Together, these ideas let you derivatives tell you where a curve rises, falls, or turns. setting the derivativ...
5. This matters because optimisation appears in scheduling, ml, graphics, and resource allocation.

## Example 2 - Basic Procedure
**Question:** Solve a standard problem from applications of differentiation.

**Worked solution:**
1. Read the problem and identify the given information.
2. Write down the relevant definition or rule from [[9.4 Applications of Differentiation]].
...
**Question:** Show how applications of differentiation appears in a programming context.

**Worked solution:**
1. Name the CS object: hyperparameter tuning.
2. Name the mathematical object: [[turning point]].
3. Explain the link: Optimisation appears in scheduling, ML, graphics, and resource allocation.
...
**Worked solution:**
1. Identify which prerequisite applies: [[9.3 Differentiation Rules]].
