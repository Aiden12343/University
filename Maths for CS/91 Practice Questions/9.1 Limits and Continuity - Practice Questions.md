...
Answers: [[9.1 Limits and Continuity - Answers]]
...
## A. Vocabulary
1. Define [[limit]] in one sentence.
2. Define [[approach]] in one sentence.
3. Define [[continuity]] in one sentence.
4. Define [[one-sided limit]] in one sentence.
5. Define [[undefined point]] in one sentence.
6. What is the plain-English idea of limits and continuity?
...
## D. Mixed Practice
19. Combine this topic with [[1.2 Place Value and Number Lines]].
