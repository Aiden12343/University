...
Answers: [[9.10 Convex Optimisation Basics - Answers]]
...
## A. Vocabulary
1. Define [[convex function]] in one sentence.
2. Define [[convex set]] in one sentence.
3. Define [[global minimum]] in one sentence.
4. Define [[constraint]] in one sentence.
5. Define [[Lagrange multiplier]] in one sentence.
6. What is the plain-English idea of convex optimisation basics?
...
## D. Mixed Practice
19. Combine this topic with [[9.9 Gradient Descent and Optimisation]].
