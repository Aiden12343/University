...
## A. Vocabulary
1. Define [[derivative]] in one sentence.
2. Define [[gradient function]] in one sentence.
3. Define [[tangent]] in one sentence.
4. Define [[rate of change]] in one sentence.
5. Define [[first principles]] in one sentence.
6. What is the plain-English idea of differentiation basics?
...
## D. Mixed Practice
19. Combine this topic with [[9.1 Limits and Continuity]].
