...
Answers: [[9.3 Differentiation Rules - Answers]]
...
## A. Vocabulary
1. Define [[power rule]] in one sentence.
2. Define [[product rule]] in one sentence.
3. Define [[quotient rule]] in one sentence.
4. Define [[chain rule]] in one sentence.
5. Define [[implicit differentiation]] in one sentence.
6. What is the plain-English idea of differentiation rules?
...
## D. Mixed Practice
19. Combine this topic with [[9.2 Differentiation Basics]].
