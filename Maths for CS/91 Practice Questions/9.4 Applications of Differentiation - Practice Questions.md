...
Answers: [[9.4 Applications of Differentiation - Answers]]
...
## A. Vocabulary
1. Define [[turning point]] in one sentence.
2. Define [[maximum]] in one sentence.
3. Define [[minimum]] in one sentence.
4. Define [[stationary point]] in one sentence.
5. Define [[second derivative]] in one sentence.
6. What is the plain-English idea of applications of differentiation?
...
## D. Mixed Practice
19. Combine this topic with [[9.3 Differentiation Rules]].
