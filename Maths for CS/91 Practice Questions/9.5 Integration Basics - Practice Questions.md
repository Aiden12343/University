...
Answers: [[9.5 Integration Basics - Answers]]
...
## A. Vocabulary
1. Define [[integral]] in one sentence.
2. Define [[area under curve]] in one sentence.
3. Define [[antiderivative]] in one sentence.
4. Define [[constant of integration]] in one sentence.
5. Define [[definite integral]] in one sentence.
6. What is the plain-English idea of integration basics?
...
## D. Mixed Practice
19. Combine this topic with [[9.4 Applications of Differentiation]].
