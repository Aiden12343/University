...
## A. Vocabulary
1. Define [[objective function]] in one sentence.
2. Define [[learning rate]] in one sentence.
3. Define [[gradient descent]] in one sentence.
4. Define [[local minimum]] in one sentence.
5. Define [[convergence]] in one sentence.
6. What is the plain-English idea of gradient descent and optimisation?
...
## D. Mixed Practice
19. Combine this topic with [[9.8 Multivariable Functions]].
...
25. Name one CS application of gradient descent and optimisation.
26. Write pseudocode showing the mathematical idea.
27. Explain what bug could occur if a programmer ignores this topic.
28. Connect this topic to weight updates in neural networks.
