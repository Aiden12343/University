...
2. Define [[approach]].
3. Define [[continuity]].
4. Define [[one-sided limit]].
5. Define [[undefined point]].
...
16. (1 mark) Write one sentence linking this topic to floating-point convergence checks.
...
Decision:
- [ ] Pass — move to [[9.2 Differentiation Basics]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.1 Limits and Continuity]] and redo the worked examples.
