...
1. Define [[convex function]].
2. Define [[convex set]].
3. Define [[global minimum]].
4. Define [[constraint]].
5. Define [[Lagrange multiplier]].
...
16. (1 mark) Write one sentence linking this topic to SVM hinge loss (convex).
...
Decision:
- [ ] Pass — move to [[10.1 Big O Theta and Omega]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.10 Convex Optimisation Basics]] and redo the worked examples.
