...
1. Define [[power rule]].
2. Define [[product rule]].
3. Define [[quotient rule]].
4. Define [[chain rule]].
...
16. (1 mark) Write one sentence linking this topic to automatic differentiation (autograd).
...
Decision:
- [ ] Pass — move to [[9.4 Applications of Differentiation]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.3 Differentiation Rules]] and redo the worked examples.
