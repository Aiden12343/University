...
1. Define [[turning point]].
2. Define [[maximum]].
3. Define [[minimum]].
4. Define [[stationary point]].
5. Define [[second derivative]].
...
16. (1 mark) Write one sentence linking this topic to hyperparameter tuning.
...
Decision:
- [ ] Pass — move to [[9.5 Integration Basics]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.4 Applications of Differentiation]] and redo the worked examples.
