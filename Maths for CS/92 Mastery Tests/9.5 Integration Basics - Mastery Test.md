...
1. Define [[integral]].
2. Define [[area under curve]].
3. Define [[antiderivative]].
4. Define [[constant of integration]].
5. Define [[definite integral]].
...
16. (1 mark) Write one sentence linking this topic to probability density integration.
...
Decision:
- [ ] Pass — move to [[9.6 Integration Techniques]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.5 Integration Basics]] and redo the worked examples.
