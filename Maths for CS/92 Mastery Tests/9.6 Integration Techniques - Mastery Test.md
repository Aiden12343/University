...
2. Define [[integration by parts]].
3. Define [[partial fractions]].
4. Define [[trig integral]].
...
16. (1 mark) Write one sentence linking this topic to Simpson's rule in scientific computing.
...
Decision:
- [ ] Pass — move to [[9.7 Differential Equations Intro]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.6 Integration Techniques]] and redo the worked examples.
