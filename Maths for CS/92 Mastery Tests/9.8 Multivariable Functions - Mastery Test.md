...
2. Define [[gradient vector]].
3. Define [[level curve]].
4. Define [[surface]].
5. Define [[Jacobian]].
...
16. (1 mark) Write one sentence linking this topic to loss functions with many weights.
...
Decision:
- [ ] Pass — move to [[9.9 Gradient Descent and Optimisation]].
- [ ] Review — create a correction note in [[94 Review Sheets]] and retake tomorrow.
- [ ] Restart — reread [[9.8 Multivariable Functions]] and redo the worked examples.
